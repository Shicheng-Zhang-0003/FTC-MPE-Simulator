...
static void a3_positional_depenetration_pass(broadphase_pair *pair_buffer, int *pair_count_pointer,
...
gboolean physics_step_increment(gpointer user_data_pointer) {
    ...
    if ((main_inputs.enter_spawn_held) && (!editor_dialog_active) && (!main_inputs.is_menu_open) &&
