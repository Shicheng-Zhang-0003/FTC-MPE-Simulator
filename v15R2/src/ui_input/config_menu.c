...
void config_menu_key_press(int key_number) {
    ...
    if (config_menu_level == 1) {
        ...
        if (key_number == 1) {
            config_menu_active_category = cat_world;
            config_menu_level = 10 + cat_world;
        } else if (key_number == 2) {
            config_menu_active_category = cat_timestep;
            config_menu_level = 10 + cat_timestep;
        } else if (key_number == 3) {
            config_menu_active_category = cat_sleep;
            config_menu_level = 10 + cat_sleep;
        } else if (key_number == 4) {
            config_menu_active_category = cat_solver;
            config_menu_level = 10 + cat_solver;
        } else if (key_number == 5) {
            config_menu_active_category = cat_depenetration;
            config_menu_level = 10 + cat_depenetration;
        } else if (key_number == 7) {
            config_menu_active_category = cat_broadphase;
            config_menu_level = 10 + cat_broadphase;
        } else if (key_number == 8) {
            config_menu_active_category = cat_joints;
            config_menu_level = 10 + cat_joints;
        } else if (key_number == 9) {
            config_menu_active_category = cat_boundary;
        ...
        if (key_number == 1) {
            config_menu_active_category = cat_spawner;
            config_menu_level = 10 + cat_spawner;
        } else if (key_number == 2) {
            config_menu_active_category = cat_body_defaults;
            config_menu_level = 10 + cat_body_defaults;
        } else if (key_number == 3) {
            config_menu_active_category = cat_camera;
            config_menu_level = 10 + cat_camera;
        } else if (key_number == 4) {
            config_menu_active_category = cat_render;
            config_menu_level = 10 + cat_render;
        } else if (key_number == 5) {
