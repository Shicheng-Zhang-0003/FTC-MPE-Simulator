...
static void term_out(const char *text) {
    term_append_with_tag(NULL, text);
}
static void term_ok(const char *text) {
    term_append_with_tag("term_ok", text);
}
static void term_err(const char *text) {
    term_append_with_tag("term_err", text);
}
static void term_echo(const char *text) {
    term_append_with_tag("term_echo", text);
}
static void term_dim(const char *text) {
